          ...
          <?php
            function AfficherBouttonPaginer($lien,$pAvant,$pSuivante){ // précédente
                // Ici pas de parametre 'departement' 
              ...
              echo'<div class=" pagination_div" style="text-align: center;">';
                echo "<form action='$lien' method='POST' style='display:inline;margin:5px'>";
                    ...
                    echo "<button type='submit' class='btn world-btn' 
                          data-toggle='tooltip' data-placement='bottom'
                      title='Cliquer ici pour aller à la page $pAvant'>
                ...
                echo "<form action='$lien' method='POST' style='display:inline;margin:5px'>";
                  ...
                  echo "<button type='submit' class='btn world-btn'  
                          data-toggle='tooltip' data-placement='bottom'
                      title='Cliquer ici pour aller à la page $pSuivante'>
