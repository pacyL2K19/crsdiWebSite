        ...
        //  include('paginer_competances.php'); 
        //getAticles_voir_plus('client',$depart, $Article_max_afficher); 
            $competances = getcompetancesVoirPlus(1,5);
        ...
        <div class="card">
            <div class="row">     
                        ...
                        <h2 class="mb-0">
                            ...
                            <button class="btn btn-link" type="button" <?php echo("data-target=#".$var_collapse." aria-controls=".$var_collapse." aria-expanded=".$var_bool);?>  data-toggle="collapse">
                                <div class='post-thumbnail' 
                                     style="box-shadow: 2px 3px 4px 2px black;
                                    border: 2px black outset;
                                    border-radius: 5px;" 
                                    title="Cliquer pour voir le contenu Synthétisé">
                ...
                <div class="col-6 col-lg-8" style="padding-top:8%;">
                        <?php  echo("<a href='talents.php?id=".$competances['ID_competance']."' class='headline'  title='Cliquer ici pour voir tout son contenu '>
    ...
    <nav  aria-label="Page navigation example"> 
          ...
          <ul class="l"> 
                <div class='div_global' style="text-align: center;">
                       <li class="page-item load-more-btn mt-50 text-center" style="display:inline;">
<button> <span aria-hidden='true'>&laquo;</span></button> 
                        </li>
                        <strong><span id="page_actuelle"></span></strong><span id="page_tot"></span>
                        <li class="page-item" style="display: inline;">
                           <input style='display:none;'  id='input_next'  value="1" />                                                    
                           <button  type='submit' id='bb_clickNEXT'  class='btn world-btn'><span aria-hidden='true'>&raquo;</span></button>
                        </li>
                </div>
             </ul>
    </nav> 
