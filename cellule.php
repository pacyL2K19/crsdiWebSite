                    ...
                    <div class="post-content-area mb-100">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab2" data-toggle="tab" href="#world-tab-2" role="tab" aria-controls="world-tab-2" aria-selected="false">Technologie</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="tab3" data-toggle="tab" href="#world-tab-3" role="tab" aria-controls="world-tab-3" aria-selected="false">Science Exacte &amp; Experimentale</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="tab4" data-toggle="tab" href="#world-tab-4" role="tab" aria-controls="world-tab-4" aria-selected="false">Sciences humaines &amp; de la vie</a>
                                </li>
                ...
                <div class="col-12 col-md-8 col-lg-4">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title">Les Cellules au CRSDI</h5>
                            <div class="widget-content">
                                <p>Les cellules de recherche subdivisées en unités de recherche constituent les blocs fonctionnels de l’organisation, car les principales activités du centre se déroulent au sein de ces unités. Elles sont principalement constitues des membres chercheurs. </p>
                            </div>
                        </div>
                        <!-- Widget Area -->
                        <div class="sidebar-widget-area">
