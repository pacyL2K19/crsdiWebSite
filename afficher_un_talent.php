<?php
    ...
    $competances = ShowCompetance($id); // creation 'un tableau associatif contenant les talents d'un chercheur 

  
    function afficher_competancesPTformat(){  // CETTE FONCTION AFFICHE LES LES TALENTS D'UN CHERCCHEUR
            $competances = getCompetances();
        foreach ($competances as $competances) {
            ...
            <div class='single-blog-post post-style-2 d-flex align-items-center'>
                ...
                <div class='post-content'>
                    <a href='article.php?id=".$competances['ID_competance']."' class='headline'>
                        <h4 style='text-align:center;'>".$competances['nom_chercheur']."</h4>
                    </a>
                    <!-- Post Meta -->
                    <div class='post-meta'>
                        <h5>Competances</h5>
                            <div>".$competances['competance']."</div>

                        <h5>Objectifs</h5>
                            <div>".$competances['objectif']."</div>

                        <a href='article.php?id=".$competances['ID_competance']."'class='post-author'>".$competances['nom_chercheur']."</a> le <a href='#' class='post-date'>".$competances['date_post']."</a>
                    </div>
                </div>
            </div>
            </div>   
...
?>
    ...
    <!-- ********** Hero Area Start ********** -->
    <div class="hero-area height-600 bg-img background-overlay" style="background-image: url(admin/img/uploads/<?= $competances['cover'];?>);">
